...
namespace AO_Lib
{
    ...
    {
        public override bool SweepAvailable => true;
            ...
            bool m_repeat = true)
        {
            ...
            { //передача начальной, конечной частот и шага
                ...
                data_iFreq = STC_Filter.uLong_to_4bytes(data_lvspom);
        ...
        {
            var b = Create_byteMass_forHzTune(pfreq, pCoef_PowerDecrease);

            string s = String.Format(CultureInfo.InvariantCulture, "3 {0} {1} {2} {3} {4} {5} ", b[1], b[2], b[3], b[4], b[5], b[6]);
            return s;
        }
